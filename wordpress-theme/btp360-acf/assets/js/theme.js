(function () {
  const dashboardUrl = (window.btp360Data && window.btp360Data.dashboardUrl) || '/dashboard-client/';
  ...
  if (formRoot) {
    ...
    const subcategoriesByCategory = {
      ...
      Manutention: ['Chariot elevateur', 'Chariot telescopique', 'Gerbeur', 'Nacelle'],
      'Poids Lourds': ['Tracteur routier', 'Camion', 'Ensemble routier', 'Semi remorque'],
      Agricole: ['Tracteur agricole', 'Moissonneuse', 'Outils du sol', 'Fenaison'],
    };
